...
namespace NuGetGallery.ViewModels
{
    public class ListPackageItemViewModelFacts
    {
        ...
        public void UsesNormalizedVersionForDisplay()
        {
            ...
            var packageViewModel = new ViewModelHelper(Mock.Of<ISecurityPolicyService>()).CreateListPackageItemViewModel(package, currentUser: null);
        ...
        public void ShortDescriptionsNotTruncated()
        {
            ...
            var listPackageItemViewModel = new ViewModelHelper(Mock.Of<ISecurityPolicyService>()).CreateListPackageItemViewModel(package, currentUser: null);
...
#pragma warning restore 0618
        ...
        public class SignerInformation
        {
            ...
            {
                var viewModel = new ViewModelHelper(Mock.Of<ISecurityPolicyService>()).CreateListPackageItemViewModel(_package, _user1);
