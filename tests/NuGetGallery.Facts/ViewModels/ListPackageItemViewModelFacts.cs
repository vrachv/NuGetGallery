...
namespace NuGetGallery.ViewModels
{
    public class ListPackageItemViewModelFacts
    {
        ...
        public void UsesNormalizedVersionForDisplay()
        {
            ...
            var packageViewModel = ViewModelHelper.CreateListPackageItemViewModel(package, currentUser: null);
        ...
        public void ShortDescriptionsNotTruncated()
        {
            ...
            var listPackageItemViewModel = ViewModelHelper.CreateListPackageItemViewModel(package, currentUser: null);
...
#pragma warning restore 0618
        ...
        public class SignerInformation
        {
            ...
            {
                var viewModel = ViewModelHelper.CreateListPackageItemViewModel(_package, _user1);
