...
namespace NuGetGallery.Helpers
{
    ...
    {
        public class TheCreateListPackageItemRequiredSignerViewModelMethod : ViewModelHelperFactsBase
        {
            private readonly User _currentUser;
            private readonly User _otherUser;
            private readonly Mock<ISecurityPolicyService> _securityPolicyService;

            public TheCreateListPackageItemRequiredSignerViewModelMethod()
            {
            ...
            {
                var exception = Assert.Throws<ArgumentNullException>(() => _target.CreateListPackageItemRequiredSignerViewModel(
                    package: null,
            ...
            public void WhenCurrentUserIsNull_Throws()
            {
                ...
                var exception = Assert.Throws<ArgumentNullException>(
                    () => _target.CreateListPackageItemRequiredSignerViewModel(
                        package,
                        currentUser: null,
                        wasAADLoginOrMultiFactorAuthenticated: true));
            ...
            public void WhenPackageHasOneOwnerAndItIsTheCurrentUser_WhenRequiredSignerIsNull()
            {
                ...
                var viewModel = _target.CreateListPackageItemRequiredSignerViewModel(
                    package,
                    _currentUser,
                    wasAADLoginOrMultiFactorAuthenticated: true);
