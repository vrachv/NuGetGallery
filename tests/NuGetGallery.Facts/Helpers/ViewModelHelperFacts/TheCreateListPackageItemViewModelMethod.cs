    ...
    public partial class ViewModelHelperFacts
    {
        public class TheCreateListPackageItemViewModelMethod : ViewModelHelperFactsBase
        {
            ...
            public void UsesNormalizedVersionForDisplay()
            {
                ...
                var packageViewModel = _target.CreateListPackageItemViewModel(package, currentUser: null);
            ...
            public void ShortDescriptionsNotTruncated()
            {
                ...
                var listPackageItemViewModel = _target.CreateListPackageItemViewModel(package, currentUser: null);
...
#pragma warning restore 0618
            ...
            public class SignerInformation : ViewModelHelperFactsBase
            {
                ...
                {
                    var viewModel = _target.CreateListPackageItemViewModel(_package, _user1);
