...
namespace NuGetGallery.Helpers
{
    ...
    {
        public class TheCreatePackageViewModelMethod : ViewModelHelperFactsBase
        {
            [Fact]
            public void UsesNormalizedVersionForDisplay()
            {
                ...
                var packageViewModel = _target.CreatePackageViewModel(package);
            ...
            public void PackageStatusSummaryThrowsForUnexpectedPackageStatus()
            {
                ...
                // Assert
                Assert.Throws<ArgumentOutOfRangeException>(() => _target.CreatePackageViewModel(package));
            }
        }
    }
}
