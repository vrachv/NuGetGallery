...
namespace NuGetGallery.Helpers
{
    ...
    {
        public class TheCreateDisplayLicenseViewModelMethod : ViewModelHelperFactsBase
        {
            [Theory]
            ...
            public void ItInitializesLicenseFileTypeAndLicenseExpression(EmbeddedLicenseFileType embeddedLicenseType, string licenseExpression)
            {
                ...
                // act
                var model = _target.CreateDisplayLicenseViewModel(package, licenseExpressionSegments: null, licenseFileContents: null);
            ...
            public void ItInitializesLicenseExpressionSegments()
            {
                ...
                // act
                var model = _target.CreateDisplayLicenseViewModel(package, licenseExpressionSegments: segments, licenseFileContents: null);
            ...
            public void ItInitializesLicenseFileContents()
            {
                ...
                // act
                var model = _target.CreateDisplayLicenseViewModel(package, licenseExpressionSegments: null, licenseFileContents: licenseFileContents);
